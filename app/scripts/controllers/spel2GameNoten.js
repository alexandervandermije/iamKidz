...
/**
 * @ngdoc function
 * @name kidsApp.controller:Spel2gamenotenCtrl
 * @description
 * # Spel2gamenotenCtrl
 * Controller of the kidsApp
 */
angular.module('kidsApp')
  .controller('Spel2gamenotenCtrl', function ($scope,ngAudio,ngDialog,$rootScope,$location) {
   $scope.horlogeAudio = ngAudio.load('audio/horlogeAudio.wav');
    ...
    var toonDuurAudio = ngAudio.load('audio/text/toonDuur.wav');
    toonDuurAudio.play();
    ...
    $scope.checkMaat = function()
    {
        ...
        else if($scope.maatFilled > 4)
        {
            ...
            $scope.notenBalkBackground.empty();
        }
    }
    $scope.checkRound = function()
    {
        ...
        {
            console.log($scope.notenBalkBackground)
        }
